...
By default, the [puppet-mysql](https://github.com/ULHPC/puppet-mysql) repository is bound to the [ulhpc-puppet-mysql](http://ulhpc-puppet-mysql.rtfd.org) project on Read the Docs (to avoid confusion with other mysql projects). 
